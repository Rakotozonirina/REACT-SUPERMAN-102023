...
return (
    <>
        <main className='w-[100%] h-[330dvh] max-sm:px-[2rem] max-sm:h-[1000dvh] sm:max-md:h-[900dvh] md:max-lg:h-[620dvh] lg:max-xl:h-[350vh] lg:max-xl:gap-[80px] flex flex-col gap-[40px] px-[5rem] bg-gradient-to-br from-[#000000] to-[#06090e]'>
        ...
        <section className='h-[130dvh] max-sm:px-[0rem] max-sm:h-[180dvh] sm:max-md:h-[160vh] max-sm:gap-[20rem] sm:max-md:gap-[100px] flex flex-col items-center w-full px-[3rem] bg-gradient-to-br from-[#000000] to-[#06090e]'>
            <div className='w-full h-[80dvh] px-[2rem] max-sm:px-0 bgImageEleven grayscale'>
                <article className='w-full h-[100dvh] max-sm:px-[2rem] bg-black/75'>
                    <h1 className='text-white font-rajdhani max-sm:text-[32px] text-[36px]'>BATMAN V SUPERMAN</h1>
                    ...
                    <section>
                        <h2 className='text-white font-rajdhani max-sm:text-[32px] text-[36px]'>MULTIMEDIA</h2>
                    </section>
                </article>
            </div>
            <Splide aria-label="My Favorite Images" options={{ width: "80%", height: "40dvh", gap: '1rem',}}>
                ...
                <div className="centered-slide">
                    <div className="flex rounded-r-md bg-gradient-to-br from-[#19587D] to-[#193C7D] h-[40vh] sm:max-md:scale-[0.8] md:max-lg:w-[500px] w-[600px]">
                        ...
                        <article className='w-[65%] flex flex-col gap-1 justify-center'>
                            <p className='font-cantarell text-white max-sm:text-[12px] text-[16px] uppercase'>Action, Adventure</p>
                            <h2 className='font-cantarell text-white max-sm:text-[16px] text-[20px]'>Superman Man of Steel</h2>
                            <h2 className='text-white font-bold max-sm:text-[16px] text-[20px]'>IMDB: <span className='text-[#F1C530]'>7.1</span></h2>
                            <p className='font-cantarell text-white max-sm:text-[12px] text-[16px]'>Clark Kent, malgré son apparence humaine normale, est l'un des derniers membres d'une race éteinte. Il se retrouve forcé de révéler son identité lorsque la Terre est envahie par une armée de survivants qui menacent détruire la planète.</p>
                        </article>
                    </div>
                </div>
                </SplideSlide>
                ...
                <div className="centered-slide">
                    <div className="flex bg-gradient-to-br rounded-r-md from-[#19587D] to-[#193C7D] h-[40vh] sm:max-md:scale-[0.8] md:max-lg:w-[500px] w-[600px]">
                        ...
                        <article className='w-[65%]  flex flex-col gap-3 justify-center'>
                            <p className='font-cantarell text-white max-sm:text-[12px] text-[16px] uppercase'>Action, Adventure</p>
                            <h2 className='font-cantarell text-white max-sm:text-[16px] text-[20px]'>Superman (1978)</h2>
                            <h2 className='text-white font-bold max-sm:text-[16px] text-[20px]'>IMDB: <span className='text-[#F1C530]'>7.4</span></h2>
                            <p className='font-cantarell text-white max-sm:text-[12px] text-[16px]'>Un orphelin extra-terrestre est envoyé de sa planète mourante sur Terre, où il grandit et devient le premier et le plus grand super-héros de sa planète d'adoption.</p>
                        </article>
                    </div>
                </div>
                </SplideSlide>
                ...
                <div className="centered-slide">
                    <div className="flex bg-gradient-to-br rounded-r-md from-[#21465c] to-[#193C7D] sm:max-md:scale-[0.8] md:max-lg:w-[500px] h-[40vh] w-[600px]">
                        ...
                        <article className='w-[65%] flex flex-col gap-3 justify-center'>
                            <p className='font-cantarell text-white max-sm:text-[12px] text-[16px] uppercase'>Action, Adventure</p>
                            <h2 className='font-cantarell text-white max-sm:text-[16px] text-[20px]'>Batman V Superman</h2>
                            <h2 className='text-white font-bold max-sm:text-[16px] text-[20px]'>IMDB: <span className='text-[#F1C530]'>6.4</span></h2>
                            <p className='font-cantarell text-white max-sm:text-[12px] text-[16px]'>Craignant que les actions de Superman ne soient pas contrôlées, Batman affronte l'homme d'acier, tandis que le monde débat du type de héros dont il a vraiment besoin.</p>
                        </article>
                    </div>
                </div>
                </SplideSlide>
        ...
        <section className='w-full h-[100dvh] max-sm:h-[60dvh] flex justify-center items-center bg-gradient-to-br from-[#000000] to-[#06090e]'>
            <div className='w-[70%] h-[90dvh] max-sm:w-[90%] max-sm:flex max-sm:justify-center max-sm:items-center max-sm:h-[60dvh]'>
                <video src={Video} autoplay controls poster={ImageFiteen} className='object-cover' type="video/mp4"> </video>
            </div>
        </section>
        <section className='bgContact w-full max-sm:h-[130dvh] h-[100dvh]'>
            <div className='w-full h-[100dvh] max-sm:h-[130dvh] flex justify-center items-center bg-[#193C7D]/75 '>
                <section className='w-[66%] h-[100dvh] max-sm:h-[130dvh] max-sm:w-[90%]'>
                    <h1 className='text-white font-rajdhani max-sm:text-[32px] text-[36px] text-center my-2'>PRENONS CONTACT</h1>
                    <form>
                        <div className='flex flex-col'>
                            <label for="email" className="text-white font-cantarell text-[22px] max-sm:text-[18px] uppercase my-2">Adresse email</label>
                        ...
                        <h1 className='text-white font-cantarell max-sm:text-[18px] text-[22px] my-3'>NEWSLETTER</h1>
                        <div class="my-1">
                        ...
                        <div className="w-full h-[6rem] max-sm:h-[16rem] max-sm:flex-col max-sm:gap-[2rem] flex justify-center items-center">
                            <input type="button" value="Des films"/>
                            <input type="button" value="Des comics"/>
                            <input type="button" value="De tout"/>
                        </div>
                        <div className="flex flex-col my-2">
                            <label for="commentaire" className='text-white font-cantarell text-[22px] max-sm:text-[18px] uppercase'>message</label>
        ...
        <section className='w-full h-[70dvh] flex relative justify-center items-center bg-gradient-to-br from-[#21465c] to-[#193C7D]'>
            <div className='w-fit absolute max-sm:top-[10%] top-[15%] left-[20%]'>
