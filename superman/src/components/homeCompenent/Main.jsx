...
return (
    <>
        <main className='w-[100%] h-[330dvh] sm:max-md:h-[900dvh] md:max-lg:h-[620dvh] lg:max-xl:h-[350vh] lg:max-xl:gap-[80px] flex flex-col gap-[40px] px-[5rem] bg-gradient-to-br from-[#000000] to-[#06090e]'>
        ...
        <section className='h-[130dvh] sm:max-md:h-[160vh] sm:max-md:gap-[100px] flex flex-col items-center w-full px-[3rem] bg-gradient-to-br from-[#000000] to-[#06090e]'>
