...
return (
    <>
        <main className='w-[100%] h-[330dvh] lg:max-xl:h-[350vh] lg:max-xl:gap-[80px] flex flex-col gap-[40px] px-[5rem] bg-gradient-to-br from-[#000000] to-[#06090e]'>
        ...
        <section className='h-[130dvh] flex flex-col items-center w-full px-[3rem] bg-gradient-to-br from-[#000000] to-[#06090e]'>
            ...
            <Splide aria-label="My Favorite Images" options={{ width: "80%", height: "40dvh", gap: '1rem',}}>
                ...
                <div className="centered-slide">
                    <div className="flex rounded-r-md bg-gradient-to-br from-[#19587D] to-[#193C7D] h-[40vh] md:max-lg:w-[500px] w-[600px]">
                        <div className='w-[35%]'>
                ...
                <SplideSlide>
                <div className="centered-slide">
                    <div className="flex bg-gradient-to-br rounded-r-md from-[#19587D] to-[#193C7D] h-[40vh] md:max-lg:w-[500px] w-[600px]">
                        <div className='w-[35%]'>
                ...
                <SplideSlide>
                <div className="centered-slide">
                    <div className="flex bg-gradient-to-br rounded-r-md from-[#21465c] to-[#193C7D] md:max-lg:w-[500px] h-[40vh] w-[600px]">
                        <div className='w-[35%]'>
